...
class BaseTrainer:
    ...
    def _do_train(self, world_size=1):
        ...
        if self.model_t is not None:
            ...
            self.distillloss = FeatureLoss(channels_s=self.channels_s, channels_t=self.channels_t,
                                           distiller=self.distill_feat_type)
            ...
            for i, batch in pbar:
                ...
                if RANK in {-1, 0}:
                    ...
                    pbar.set_description(
                        ...
                        (f'{epoch + 1}/{self.epochs}', mem, *losses, self.featureloss, self.teacherloss, self.logitloss,
