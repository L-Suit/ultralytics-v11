...
class yolov11_heatmap:
    ...
    def draw_detections(self, box, color, name, img):
        ...
        cv2.putText(img, str(name), (xmin, ymin - 5), cv2.FONT_HERSHEY_SIMPLEX, 0.5, tuple(int(x) for x in color), 1,
...
def get_params():
    params = {
        ...
        'weight': r'/root/autodl-tmp/detect/yolov11n_for31_epo200_lr0.001_16_AdamW_wk4_wd0.0005_sz544_mosaic0_3/weights/last.pt',
...
if __name__ == '__main__':
    img_path = r'/root/dataset/for31-weatherv2/images/val/2039_90d.jpg'
    save_path = '/root/autodl-tmp/heatmap-result-v11n'
